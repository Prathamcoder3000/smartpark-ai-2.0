...
export const MAP_AI_RECOMMENDATION: AIMapRecommendation = {
  ...
  confidence: '96.8%',
  reasons: [
    'Highest real-time availability in the BKC metro region',
...
export const MAP_POPULAR_DESTINATIONS: string[] = [
  'BKC Bandra East',
  'Fort Nariman Point',
  'Andheri MIDC Tower 4',
  'Powai Hiranandani',
  'Bandra Linking Road Mall',
...
export const MAP_ZONE_OPTIONS = [
  ...
  { value: 'Zone A', label: 'Zone A — BKC & Powai' },
  { value: 'Zone B', label: 'Zone B — Fort South Mumbai' },
  { value: 'Zone C', label: 'Zone C — Bandra Retail & Entertainment' },
  { value: 'Zone D', label: 'Zone D — Promenade & Outer' },
];
