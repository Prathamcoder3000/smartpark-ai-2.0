...
export const POPULAR_DESTINATIONS: SearchDestination[] = [
  { id: 'dest-1', name: 'BKC Bandra East', category: 'Commercial Hub', nearbyFacilityCount: 8 },
  { id: 'dest-2', name: 'Fort South Mumbai', category: 'Transit & Financial', nearbyFacilityCount: 12 },
  { id: 'dest-3', name: 'Andheri East MIDC', category: 'Business Center', nearbyFacilityCount: 6 },
  { id: 'dest-4', name: 'Powai Hiranandani', category: 'IT & Financial Complex', nearbyFacilityCount: 9 },
  { id: 'dest-5', name: 'Bandra Linking Road', category: 'Shopping & Dining', nearbyFacilityCount: 5 },
];

export const RECENT_SEARCHES = [
  'Fort Nariman Point',
  'BKC Bandra',
  'Andheri MIDC EV Deck',
  'Powai Hiranandani',
];
...
export const MOCK_SEARCH_FACILITIES: SearchFacility[] = [
  {
    ...
    zone: 'Zone A - South Mumbai / Fort',
    location: '101 Nariman Point Boulevard, Fort, Mumbai 400021',
    status: 'AVAILABLE',
    availableBays: 142,
    totalBays: 200,
    occupancyPct: 29,
  ...
  },
  {
    ...
    zone: 'Zone B - Andheri East MIDC',
    location: '77 MIDC Central Road, Andheri East, Mumbai 400093',
    status: 'LIMITED',
    availableBays: 18,
    totalBays: 150,
    occupancyPct: 88,
  ...
  },
  {
    ...
    shortName: 'Cyber Hub',
    zone: 'Zone A - Bandra BKC',
    location: '404 BKC Avenue, Bandra East, Mumbai 400051',
    status: 'AVAILABLE',
    availableBays: 94,
    totalBays: 180,
    occupancyPct: 47,
  ...
  },
  {
    ...
    location: '55 Hiranandani Boulevard, Powai, Mumbai 400076',
    status: 'AVAILABLE',
    availableBays: 65,
    totalBays: 100,
    occupancyPct: 35,
  ...
  },
  {
    ...
    zone: 'Zone C - Bandra Retail Corridor',
  ...
  },
  {
    ...
    zone: 'Zone C - Bandra Promenade',
    location: 'Carter Road Promenade, Bandra West, Mumbai 400050',
    status: 'AVAILABLE',
    availableBays: 110,
    totalBays: 160,
    occupancyPct: 31,
